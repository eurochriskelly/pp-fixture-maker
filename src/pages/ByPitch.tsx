...
import { Fixture, Pitch, Competition } from '@/lib/types';
...
// Group colors for hexagon badges (50% opacity)
const GROUP_COLORS = [
  '#DC2626', // Red
  '#2563EB', // Blue
  '#16A34A', // Green
...
// Hexagon badge for group matches
const StageHexagon: React.FC<{ fixture: Fixture; competition: Competition }> = ({
  ...
  if (isGroup) {
    ...
    // Proper hexagon within 60x60 square, 50% opacity
    return (
      <svg
        viewBox="0 0 60 60"
        width="60"
  ...
  // Shield badge for knockout stages (finals) - gray gradient
  const finalGradientId = `finalGrad-${fixture.id}`;
  return (
    <svg
      viewBox="0 0 44 40"
      width="57"
                ...
                <CardContent className="flex-1">
                  <div className="space-y-2">
                    {matches.map((match, idx) => (
                      <div key={idx} className="rounded-lg border-[0.2rem] border-outset border-white bg-muted/30 px-4 pt-1 pb-0.5" style={{ borderStyle: 'outset' }}>
